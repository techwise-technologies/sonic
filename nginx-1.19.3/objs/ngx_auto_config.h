#define NGX_CONFIGURE " --prefix=/etc/nginx --sbin-path=/usr/sbin/nginx --modules-path=/etc/nginx/modules --conf-path=/etc/nginx/nginx.conf --error-log-path=/var/log/nginx/error.log --http-log-path=/var/log/nginx/access.log --pid-path=/var/run/nginx.pid --lock-path=/var/lock/nginx.lock --http-fastcgi-temp-path=/var/lib/nginx/fastcgi --http-client-body-temp-path=/var/lib/nginx/body --http-proxy-temp-path=/var/lib/nginx/proxy --with-openssl=../quiche/deps/boringssl --with-quiche=../quiche --with-http_ssl_module --with-http_v2_module --with-http_v3_module --with-pcre --user=www-data --group=www-data --with-threads --with-file-aio --without-select_module --without-poll_module --without-mail_pop3_module --without-mail_imap_module --without-mail_smtp_module --add-dynamic-module=../ngx_cache_purge --with-http_realip_module --with-http_gunzip_module --with-http_gzip_static_module --with-http_geoip_module --with-http_slice_module --with-http_flv_module --with-http_stub_status_module --with-http_image_filter_module=dynamic --with-stream=dynamic --with-http_addition_module --with-http_mp4_module"
